...
// CONTROL BUS
#define LCD_RW  	LATAbits.LATA1	// Read/Write
#define LCD_EN  	LATAbits.LATA2	// Enable
...
// DATA BUS
#define LCD_DB0 	LATBbits.LATB4	// DB0 - in 4-bit mode it has to be the same as LCD_DB4
#define LCD_DB1 	LATBbits.LATB1	// DB1 - in 4-bit mode it has to be the same as LCD_DB5
#define LCD_DB2 	LATBbits.LATB2	// DB2 - in 4-bit mode it has to be the same as LCD_DB6
#define LCD_DB3 	LATBbits.LATB3	// DB3 - in 4-bit mode it has to be the same as LCD_DB7
#define LCD_DB4 	LATBbits.LATB4	// DB4
#define LCD_DB5 	LATBbits.LATB1	// DB5
#define LCD_DB6 	LATBbits.LATB2	// DB6
#define LCD_DB7 	LATBbits.LATB3	// DB7
